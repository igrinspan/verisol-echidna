...
contract SimpleAuction {
	...
	function vc1x0x0(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && !(pendingReturnsArray.length != 0) && !(!ended && time >= (auctionStart + biddingTime)));
		require(msg.value > highestBid);
		bid();
		assert(!(!(time <= (auctionStart + biddingTime)) && !(pendingReturnsArray.length != 0) && !(!ended && time >= (auctionStart + biddingTime))&& true));
	}
	...
	function vc1x6x0(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && !(pendingReturnsArray.length != 0) && !(!ended && time >= (auctionStart + biddingTime)));
		require(msg.value > highestBid);
		bid();
		assert(!(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	function vc1x7x0(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && !(pendingReturnsArray.length != 0) && !(!ended && time >= (auctionStart + biddingTime)));
		require(msg.value > highestBid);
		bid();
		assert(!(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime)&& true));
	...
	function vc2x6x1(address refundee) hasInitialized payable public {
		require(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !(!ended && time >= (auctionStart + biddingTime)));
		withdraw();
		assert(!(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	function vc2x7x1(address refundee) hasInitialized payable public {
		require(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !(!ended && time >= (auctionStart + biddingTime)));
		withdraw();
		assert(!(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	...
	function vc3x6x2(address refundee) hasInitialized payable public {
		require(!(time <= (auctionStart + biddingTime)) && !(pendingReturnsArray.length != 0) && !ended && time >= (auctionStart + biddingTime));
		auctionEnd();
		assert(!(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	function vc3x7x2(address refundee) hasInitialized payable public {
		require(!(time <= (auctionStart + biddingTime)) && !(pendingReturnsArray.length != 0) && !ended && time >= (auctionStart + biddingTime));
		auctionEnd();
		assert(!(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	...
	function vc4x6x0(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !(!ended && time >= (auctionStart + biddingTime)));
		require(msg.value > highestBid);
		bid();
		assert(!(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	function vc4x6x1(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !(!ended && time >= (auctionStart + biddingTime)));
		withdraw();
		assert(!(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	function vc4x7x0(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !(!ended && time >= (auctionStart + biddingTime)));
		require(msg.value > highestBid);
		bid();
		assert(!(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	function vc4x7x1(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !(!ended && time >= (auctionStart + biddingTime)));
		withdraw();
		assert(!(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	...
	function vc5x6x0(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && !(pendingReturnsArray.length != 0) && !ended && time >= (auctionStart + biddingTime));
		require(msg.value > highestBid);
		bid();
		assert(!(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	function vc5x6x2(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && !(pendingReturnsArray.length != 0) && !ended && time >= (auctionStart + biddingTime));
		auctionEnd();
		assert(!(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	function vc5x7x0(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && !(pendingReturnsArray.length != 0) && !ended && time >= (auctionStart + biddingTime));
		require(msg.value > highestBid);
		bid();
		assert(!(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	function vc5x7x2(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && !(pendingReturnsArray.length != 0) && !ended && time >= (auctionStart + biddingTime));
		auctionEnd();
		assert(!(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	function vc6x0x1(address refundee) hasInitialized payable public {
		require(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		withdraw();
		assert(!(!(time <= (auctionStart + biddingTime)) && !(pendingReturnsArray.length != 0) && !(!ended && time >= (auctionStart + biddingTime))&& true));
	}
	function vc6x0x2(address refundee) hasInitialized payable public {
		require(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		auctionEnd();
		assert(!(!(time <= (auctionStart + biddingTime)) && !(pendingReturnsArray.length != 0) && !(!ended && time >= (auctionStart + biddingTime))&& true));
	}
	function vc6x1x1(address refundee) hasInitialized payable public {
		require(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		withdraw();
		assert(!(time <= (auctionStart + biddingTime) && !(pendingReturnsArray.length != 0) && !(!ended && time >= (auctionStart + biddingTime))&& true));
	}
	function vc6x1x2(address refundee) hasInitialized payable public {
		require(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		auctionEnd();
		assert(!(time <= (auctionStart + biddingTime) && !(pendingReturnsArray.length != 0) && !(!ended && time >= (auctionStart + biddingTime))&& true));
	}
	function vc6x2x1(address refundee) hasInitialized payable public {
		require(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		withdraw();
		assert(!(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !(!ended && time >= (auctionStart + biddingTime))&& true));
	}
	function vc6x2x2(address refundee) hasInitialized payable public {
		require(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		auctionEnd();
		assert(!(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !(!ended && time >= (auctionStart + biddingTime))&& true));
	}
	function vc6x3x1(address refundee) hasInitialized payable public {
		require(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		withdraw();
		assert(!(!(time <= (auctionStart + biddingTime)) && !(pendingReturnsArray.length != 0) && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	function vc6x3x2(address refundee) hasInitialized payable public {
		require(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		auctionEnd();
		assert(!(!(time <= (auctionStart + biddingTime)) && !(pendingReturnsArray.length != 0) && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	function vc6x4x1(address refundee) hasInitialized payable public {
		require(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		withdraw();
		assert(!(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !(!ended && time >= (auctionStart + biddingTime))&& true));
	}
	function vc6x4x2(address refundee) hasInitialized payable public {
		require(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		auctionEnd();
		assert(!(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !(!ended && time >= (auctionStart + biddingTime))&& true));
	}
	function vc6x5x1(address refundee) hasInitialized payable public {
		require(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		withdraw();
		assert(!(time <= (auctionStart + biddingTime) && !(pendingReturnsArray.length != 0) && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	function vc6x5x2(address refundee) hasInitialized payable public {
		require(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		auctionEnd();
		assert(!(time <= (auctionStart + biddingTime) && !(pendingReturnsArray.length != 0) && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	function vc6x6x1(address refundee) hasInitialized payable public {
		require(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		withdraw();
		assert(!(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	function vc6x6x2(address refundee) hasInitialized payable public {
		require(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		auctionEnd();
		assert(!(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	function vc6x7x1(address refundee) hasInitialized payable public {
		require(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		withdraw();
		assert(!(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	function vc6x7x2(address refundee) hasInitialized payable public {
		require(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		auctionEnd();
		assert(!(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	...
	function vc7x0x1(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		withdraw();
		assert(!(!(time <= (auctionStart + biddingTime)) && !(pendingReturnsArray.length != 0) && !(!ended && time >= (auctionStart + biddingTime))&& true));
	}
	function vc7x0x2(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		auctionEnd();
		assert(!(!(time <= (auctionStart + biddingTime)) && !(pendingReturnsArray.length != 0) && !(!ended && time >= (auctionStart + biddingTime))&& true));
	}
	function vc7x1x0(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		require(msg.value > highestBid);
		bid();
		assert(!(time <= (auctionStart + biddingTime) && !(pendingReturnsArray.length != 0) && !(!ended && time >= (auctionStart + biddingTime))&& true));
	}
	function vc7x1x1(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		withdraw();
		assert(!(time <= (auctionStart + biddingTime) && !(pendingReturnsArray.length != 0) && !(!ended && time >= (auctionStart + biddingTime))&& true));
	}
	function vc7x1x2(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		auctionEnd();
		assert(!(time <= (auctionStart + biddingTime) && !(pendingReturnsArray.length != 0) && !(!ended && time >= (auctionStart + biddingTime))&& true));
	}
	function vc7x2x0(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		require(msg.value > highestBid);
		bid();
		assert(!(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !(!ended && time >= (auctionStart + biddingTime))&& true));
	}
	function vc7x2x1(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		withdraw();
		assert(!(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !(!ended && time >= (auctionStart + biddingTime))&& true));
	}
	function vc7x2x2(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		auctionEnd();
		assert(!(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !(!ended && time >= (auctionStart + biddingTime))&& true));
	}
	function vc7x3x0(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		require(msg.value > highestBid);
		bid();
		assert(!(!(time <= (auctionStart + biddingTime)) && !(pendingReturnsArray.length != 0) && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	function vc7x3x1(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		withdraw();
		assert(!(!(time <= (auctionStart + biddingTime)) && !(pendingReturnsArray.length != 0) && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	function vc7x3x2(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		auctionEnd();
		assert(!(!(time <= (auctionStart + biddingTime)) && !(pendingReturnsArray.length != 0) && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	function vc7x4x0(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		require(msg.value > highestBid);
		bid();
		assert(!(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !(!ended && time >= (auctionStart + biddingTime))&& true));
	}
	function vc7x4x1(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		withdraw();
		assert(!(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !(!ended && time >= (auctionStart + biddingTime))&& true));
	}
	function vc7x4x2(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		auctionEnd();
		assert(!(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !(!ended && time >= (auctionStart + biddingTime))&& true));
	}
	function vc7x5x0(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		require(msg.value > highestBid);
		bid();
		assert(!(time <= (auctionStart + biddingTime) && !(pendingReturnsArray.length != 0) && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	function vc7x5x1(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		withdraw();
		assert(!(time <= (auctionStart + biddingTime) && !(pendingReturnsArray.length != 0) && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	function vc7x5x2(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		auctionEnd();
		assert(!(time <= (auctionStart + biddingTime) && !(pendingReturnsArray.length != 0) && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	function vc7x6x0(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		require(msg.value > highestBid);
		bid();
		assert(!(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	function vc7x6x1(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		withdraw();
		assert(!(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	function vc7x6x2(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		auctionEnd();
		assert(!(!(time <= (auctionStart + biddingTime)) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	function vc7x7x0(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		require(msg.value > highestBid);
		bid();
		assert(!(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	function vc7x7x1(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		withdraw();
		assert(!(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime)&& true));
	}
	function vc7x7x2(address refundee) hasInitialized payable public {
		require(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime));
		auctionEnd();
		assert(!(time <= (auctionStart + biddingTime) && pendingReturnsArray.length != 0 && !ended && time >= (auctionStart + biddingTime)&& true));
	}
