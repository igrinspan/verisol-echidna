...
contract EPXCrowdsale is owned, safeMath {
	...
	function vc0x0x0(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) hasInitialized payable public {
		assert(!(!((!isCrowdSaleSetup && !(beneficiaryWallet != address(0x0)))) && !((tokensRemaining > 0 && (blockNumber <= fundingEndBlock) && (blockNumber >= fundingStartBlock))) && !(isCrowdSaleSetup) && !(((amountRaisedInWei < fundingMinCapInWei) && (isCrowdSaleClosed) && (blockNumber > fundingEndBlock) && (usersEPXfundValueArray.length != 0))) && true));
	}
	...
	function vc8x0x0(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) hasInitialized payable public {
		assert(!(!((!isCrowdSaleSetup && !(beneficiaryWallet != address(0x0)))) && (tokensRemaining > 0 && (blockNumber <= fundingEndBlock) && (blockNumber >= fundingStartBlock)) && isCrowdSaleSetup && !(((amountRaisedInWei < fundingMinCapInWei) && (isCrowdSaleClosed) && (blockNumber > fundingEndBlock) && (usersEPXfundValueArray.length != 0))) && true));
	}
	function vc9x0x0(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) hasInitialized payable public {
		assert(!(!((!isCrowdSaleSetup && !(beneficiaryWallet != address(0x0)))) && (tokensRemaining > 0 && (blockNumber <= fundingEndBlock) && (blockNumber >= fundingStartBlock)) && !(isCrowdSaleSetup) && ((amountRaisedInWei < fundingMinCapInWei) && (isCrowdSaleClosed) && (blockNumber > fundingEndBlock) && (usersEPXfundValueArray.length != 0)) && true));
	}
	function vc10x0x0(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) hasInitialized payable public {
		assert(!(!((!isCrowdSaleSetup && !(beneficiaryWallet != address(0x0)))) && !((tokensRemaining > 0 && (blockNumber <= fundingEndBlock) && (blockNumber >= fundingStartBlock))) && isCrowdSaleSetup && ((amountRaisedInWei < fundingMinCapInWei) && (isCrowdSaleClosed) && (blockNumber > fundingEndBlock) && (usersEPXfundValueArray.length != 0)) && true));
	}
	...
	function vc14x0x0(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) hasInitialized payable public {
		assert(!(!((!isCrowdSaleSetup && !(beneficiaryWallet != address(0x0)))) && (tokensRemaining > 0 && (blockNumber <= fundingEndBlock) && (blockNumber >= fundingStartBlock)) && isCrowdSaleSetup && ((amountRaisedInWei < fundingMinCapInWei) && (isCrowdSaleClosed) && (blockNumber > fundingEndBlock) && (usersEPXfundValueArray.length != 0)) && true));
	}
