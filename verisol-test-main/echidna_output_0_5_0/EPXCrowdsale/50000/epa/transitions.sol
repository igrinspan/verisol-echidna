...
contract EPXCrowdsale is owned, safeMath {
	function vc0x0x0(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) payable public {
	...
	function vc0x1x0(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) payable public {
		require(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Crowdsale is setup')));
		SetupCrowdsale(_fundingStartBlock, _fundingEndBlock);
		assert(!(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('In progress (Eth < Softcap)'))&& true));
	}
	function vc0x2x0(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) payable public {
		require(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Crowdsale is setup')));
		SetupCrowdsale(_fundingStartBlock, _fundingEndBlock);
		assert(!(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Successful (EPX >= Hardcap)!'))&& true));
	}
	function vc0x3x0(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) payable public {
		require(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Crowdsale is setup')));
		SetupCrowdsale(_fundingStartBlock, _fundingEndBlock);
		assert(!(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Unsuccessful (Eth < Softcap)'))&& true));
	}
	function vc0x4x0(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) payable public {
		require(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Crowdsale is setup')));
		SetupCrowdsale(_fundingStartBlock, _fundingEndBlock);
		assert(!(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Crowdsale deployed to chain'))&& true));
	}
	function vc0x5x0(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) payable public {
		require(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Crowdsale is setup')));
		SetupCrowdsale(_fundingStartBlock, _fundingEndBlock);
		assert(!(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Successful (Eth >= Softcap)!'))&& true));
	}
	function vc0x6x0(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) payable public {
		require(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Crowdsale is setup')));
		SetupCrowdsale(_fundingStartBlock, _fundingEndBlock);
		assert(!(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('In progress (Eth >= Softcap)!'))&& true));
	}
	function vc1x0x1(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) payable public {
		require(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('In progress (Eth < Softcap)')));
		buy();
		assert(!(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Crowdsale is setup'))&& true));
	}
	function vc1x1x1(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) payable public {
		require(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('In progress (Eth < Softcap)')));
		buy();
		assert(!(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('In progress (Eth < Softcap)'))&& true));
	}
	function vc1x2x1(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) payable public {
		require(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('In progress (Eth < Softcap)')));
		buy();
		assert(!(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Successful (EPX >= Hardcap)!'))&& true));
	}
	function vc1x3x1(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) payable public {
		require(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('In progress (Eth < Softcap)')));
		buy();
		assert(!(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Unsuccessful (Eth < Softcap)'))&& true));
	}
	function vc1x4x1(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) payable public {
		require(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('In progress (Eth < Softcap)')));
		buy();
		assert(!(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Crowdsale deployed to chain'))&& true));
	}
	function vc1x5x1(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) payable public {
		require(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('In progress (Eth < Softcap)')));
		buy();
		assert(!(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Successful (Eth >= Softcap)!'))&& true));
	}
	function vc1x6x1(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) payable public {
		require(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('In progress (Eth < Softcap)')));
		buy();
		assert(!(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('In progress (Eth >= Softcap)!'))&& true));
	}
	function vc2x0x2(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) payable public {
		require(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Successful (EPX >= Hardcap)!')));
		checkGoalReached();
		assert(!(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Crowdsale is setup'))&& true));
	}
	function vc2x1x2(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) payable public {
		require(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Successful (EPX >= Hardcap)!')));
		checkGoalReached();
		assert(!(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('In progress (Eth < Softcap)'))&& true));
	}
	function vc2x2x2(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) payable public {
		require(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Successful (EPX >= Hardcap)!')));
		checkGoalReached();
		assert(!(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Successful (EPX >= Hardcap)!'))&& true));
	}
	function vc2x3x2(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) payable public {
		require(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Successful (EPX >= Hardcap)!')));
		checkGoalReached();
		assert(!(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Unsuccessful (Eth < Softcap)'))&& true));
	}
	function vc2x4x2(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) payable public {
		require(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Successful (EPX >= Hardcap)!')));
		checkGoalReached();
		assert(!(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Crowdsale deployed to chain'))&& true));
	}
	function vc2x5x2(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) payable public {
		require(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Successful (EPX >= Hardcap)!')));
		checkGoalReached();
		assert(!(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Successful (Eth >= Softcap)!'))&& true));
	}
	function vc2x6x2(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) payable public {
		require(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Successful (EPX >= Hardcap)!')));
		checkGoalReached();
		assert(!(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('In progress (Eth >= Softcap)!'))&& true));
	}
	function vc3x0x3(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) payable public {
		require(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Unsuccessful (Eth < Softcap)')));
		refund();
		assert(!(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Crowdsale is setup'))&& true));
	}
	function vc3x1x3(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) payable public {
		require(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Unsuccessful (Eth < Softcap)')));
		refund();
		assert(!(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('In progress (Eth < Softcap)'))&& true));
	}
	function vc3x2x3(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) payable public {
		require(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Unsuccessful (Eth < Softcap)')));
		refund();
		assert(!(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Successful (EPX >= Hardcap)!'))&& true));
	}
	function vc3x3x3(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) payable public {
		require(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Unsuccessful (Eth < Softcap)')));
		refund();
		assert(!(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Unsuccessful (Eth < Softcap)'))&& true));
	}
	function vc3x4x3(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) payable public {
		require(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Unsuccessful (Eth < Softcap)')));
		refund();
		assert(!(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Crowdsale deployed to chain'))&& true));
	}
	function vc3x5x3(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) payable public {
		require(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Unsuccessful (Eth < Softcap)')));
		refund();
		assert(!(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Successful (Eth >= Softcap)!'))&& true));
	}
	function vc3x6x3(uint256 _amount, uint256 _fundingStartBlock,  uint256 _fundingEndBlock) payable public {
		require(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('Unsuccessful (Eth < Softcap)')));
		refund();
		assert(!(keccak256(abi.encodePacked(CurrentStatus)) == keccak256(abi.encodePacked('In progress (Eth >= Softcap)!'))&& true));
	}
